Shader "Procedural/S_GrassField"
{
    Properties
    {
        [KeywordEnum(Off,ChunkID,LOD,ClumpCell,GlobalWind)] _Debug("DebugMode", Float) = 0
    ...
    SubShader
    {
        ...
        Pass 
        {
            ...
            #pragma shader_feature _DEBUG_OFF _DEBUG_CHUNKID _DEBUG_LOD _DEBUG_CLUMPCELL _DEBUG_GLOBALWIND
