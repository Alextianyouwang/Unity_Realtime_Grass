Shader "Procedural/S_GrassField"
{
    Properties
    {
        [KeywordEnum(Off,MainWave,DetailedWave,ChunkID)] _Debug("DebugMode", Float) = 0
    ...
    SubShader
    {
        ...
        Pass 
        {
            ...
            #pragma shader_feature _DEBUG_OFF _DEBUG_MAINWAVE _DEBUG_DETAILEDWAVE _DEBUG_CHUNKID
